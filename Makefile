...
.PHONY: post-release
post-release:
	cat quickstart.yml | go tool yq '.services.kratos.image = "'$$DOCKER_FULL':'$$IMAGE_TAG'"' | sponge quickstart.yml
	cat quickstart.yml | go tool yq '.services.kratos-migrate.image = "'$$DOCKER_FULL':'$$IMAGE_TAG'"' | sponge quickstart.yml
	cat quickstart.yml | go tool yq '.services.kratos-selfservice-ui-node.image = "'$$DOCKER_REPO'/kratos-selfservice-ui-node:'$$IMAGE_TAG'"' | sponge quickstart.yml
