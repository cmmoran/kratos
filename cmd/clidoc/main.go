...
func init() {
	...
	messages = map[string]*text.Message{
		...
		"NewInfoSelfServiceSettingsEnableMethod":     text.NewInfoSelfServiceSettingsEnableMethod(),
		...
		"NewInfoSelfServiceVerificationSuccessful":                text.NewInfoSelfServiceVerificationSuccessful("{channel}"),
		"NewVerificationEmailSent":                                text.NewVerificationEmailSent(),
		"NewVerificationCodeSent":                                 text.NewVerificationCodeSent("{channel}", "{strategy}"),
		"NewVerificationEmailWithCodeSent":                        text.NewVerificationEmailWithCodeSent(),
		"NewVerificationPhoneWithCodeSent":                        text.NewVerificationPhoneWithCodeSent(),
		"NewInfoSelfServiceVerificationPhoneSuccessful":           text.NewInfoSelfServiceVerificationPhoneSuccessful(),
		...
		"NewInfoSelfServiceLoginLookupCodesAlmostDepleted":        text.NewInfoSelfServiceLoginLookupCodesAlmostDepleted(1),
		"NewInfoLoginVerify":                                      text.NewInfoLoginVerify(),
		"NewInfoTrustDeviceLabel":                                 text.NewInfoTrustDeviceLabel(),
		...
		"NewInfoNodeInputEmailOrPhone":                            text.NewInfoNodeInputEmailOrPhone(),
		"NewInfoNodeInputForChannel":                              text.NewInfoNodeInputForChannel("{channel}"),
		"NewInfoNodeResendCodeVia":                                text.NewInfoNodeResendCodeVia("{channel}"),
